...
public interface UserController {
    ...
    @GetMapping("/users/{id}")
    ResponseEntity<UserDtoResponse> getUser(
    ...
    ResponseEntity<UserDtoResponse> addSubscription(
            @PathVariable Long id,
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(implementation = SubscriptionDtoResponse.class))),
                    @ApiResponse(
                            responseCode = "400",
                            description = "Bad Request",
                            content = @Content(
    ...
    ResponseEntity<SubscriptionDtoResponse> getSubscription(
            @PathVariable Long id
    );
    ...
    ResponseEntity<Boolean> deleteSubscription(
            @PathVariable Long id,
            @PathVariable Long subId
    );

    @Operation(
            summary = "Top Subscriptions")
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    ResponseEntity<SubscriptionDtoResponse> topSubscription();
}
